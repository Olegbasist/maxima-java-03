...
//  todo: 20.10.2022 В CatFactory Вы повторно проверяете условие, а нужно перехватить выброс исключения и при перехвате создать дефолтного кота.
...
public class App 
{
    public static void main( String[] args ) throws Exception {
        ...
        Cat cat = CatFactory.createCat("Рыжик", -8);

...
// TODO: 20.10.2022 В конструкторе и сеттере может быть выброшен IncorrectCatWeightException, а в сигнатуре метода описываете просто Exception это будет сбивать тех, кто будет этот класс использовать.
//  Лучше указывать точный класс исключения.
//  В CatFactory Вы повторно проверяете условие, а нужно перехватить выброс исключения и при перехвате создать дефолтного кота.
...
public class App 
{
    public static void main( String[] args ) throws Exception {
        ...
        Cat cat = CatFactory.createCat("Рыжик", 9);
